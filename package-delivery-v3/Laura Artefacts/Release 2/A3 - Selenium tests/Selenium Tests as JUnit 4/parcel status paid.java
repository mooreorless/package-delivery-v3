...
public class ParcelStatusPaid {
  ...
  @Test
  public void testParcelStatusPaid() throws Exception {
    ...
    driver.findElement(By.id("cardNumber")).sendKeys("1234 5467 8910 1112");
    driver.findElement(By.cssSelector("div.col-xs-4 > p > #cardNumber")).clear();
    driver.findElement(By.cssSelector("div.col-xs-4 > p > #cardNumber")).sendKeys("123");
    driver.findElement(By.id("cardExp")).clear();
    driver.findElement(By.id("cardExp")).sendKeys("18/22");
