...
public class ParcelStatusPickedUp {
  ...
  @Test
  public void testParcelStatusPickedUp() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.panel.panel-warning > div.panel-heading. > h3.panel-title.clickable")).click();
    new Select(driver.findElement(By.xpath("//div[@id='add-margin']/div/div/div/select"))).selectByVisibleText("Picked Up");
    try {
      assertEquals("Success", driver.findElement(By.cssSelector("div.toast.toast-success > div > div.toast-title")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
