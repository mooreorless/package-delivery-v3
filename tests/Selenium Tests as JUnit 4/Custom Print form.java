...
public class CustomPrintForm {
  ...
  @Test
  public void testCustomPrintForm() throws Exception {
    ...
    for (int second = 0;; second++) {
    	...
    	try { if (isElementPresent(By.cssSelector("span.float-right > a > i.material-icons"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }

    driver.findElement(By.cssSelector("span.float-right > a > i.material-icons")).click();
